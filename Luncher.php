...
به ربات ما امتیاز بدید  👈        [pm resan](https://telegram.me/storebot?start=pm_resanrobot)
عضو کانال ما شوید  👈        [channel](https://telegram.me/joinchat/BxxSlkFffDHgtH400-B2Dg)
هر نفر = یک ربات ✖️
ربات دوم = 4000ت ✔️
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url= http://phppv-mehdiphpso.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url= http://phppv-mehdiphpso.rhcloud.com/'.$chat_id.'/pvresan.php');
...
.";
    ...
    $bot_url    = "https://api.telegram.org/bot261279843:AAHxCjDc-FDMLU0EE2ANbHx233AFJq9pAQk/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=http://phppv-mehdiphpso.rhcloud.com/'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=pm_resanrobot
...
define('WEBHOOK_URL', 'http://phppv-mehdiphpso.rhcloud.com/');
